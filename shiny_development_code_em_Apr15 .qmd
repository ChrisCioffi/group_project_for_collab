  ...
  output$itemized_plot <- renderPlotly({
    ...
    df_long <- df |>
      ...
      mutate(Type = recode(Type,
                           ...
                           individual_itemized_contributions = "From donors giving over $200",
                           other_political_committee_contributions = "From PAC Donations"))
    
    plot_ly(df_long, x = ~name, y = ~Amount, color = ~Type, type = "bar") |>
      layout(title = "Itemized vs PAC Contributions", barmode = "stack")
  })
